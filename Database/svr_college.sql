...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2023 at 08:04 AM
...
--
-- Table structure for table `reqres`
--
...
--
-- Dumping data for table `reqres`
--

INSERT INTO `reqres` (`id`, `question`, `answer`) VALUES
(1, 'Hi', 'What can i do for you'),
(3, 'hello', 'hello'),
(6, 'how', 'hoe'),
(7, 'hh', 'hh');
...
--
-- Table structure for table `unans`
--
...
--
-- Dumping data for table `unans`
--

INSERT INTO `unans` (`id`, `question`, `status`) VALUES
(1, 'how', 1),
(2, 'hm', 0),
(3, 'hh', 1);
...
--
-- AUTO_INCREMENT for table `reqres`
--
ALTER TABLE `reqres`
...
--
-- AUTO_INCREMENT for table `unans`
--
ALTER TABLE `unans`
